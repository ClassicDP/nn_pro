#!/usr/bin/env python3
"""
Тест NanoDet-M 192x192 для детекции автомобилей с оценкой качества
192x192 - минимальное разрешение для тестирования скорости
"""
import cv2
import numpy as np
import time
...
def main():
    log("="*60)
    log("Тест NanoDet-M 192x192 для детекции автомобилей")
    log("="*60)
